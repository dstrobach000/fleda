...
export default function ProgramAndNewsSection({
  ...
  const programHeadingHref = showNovinky ? "/program" : "#program";

  return (
    <section className="px-6 pt-6 pb-4 bg-gray-200" id="program">
      <div className={showNovinky ? "grid grid-cols-1 lg:grid-cols-2 gap-6" : "grid grid-cols-1"}>
        {/* PROGRAM */}
        <div className="w-full">
          <h2 className="font-light text-xl sm:text-2xl text-black">
            <a href={programHeadingHref} className="inline-flex items-center gap-2">
              <span>Program</span>
