...
function venueTag(venue: VenueKey): { label: string; glowColor: string } {
  switch (venue) {
    ...
    case "fraktal":
      return { label: "FRAKTAL", glowColor: "bg-[#6e5a23]" };
    case "fleda":
    default:
    ...
    <section className="px-6 pt-6 pb-4 bg-gray-200" id="program">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="w-full">
          <h2 className="font-light text-xl sm:text-2xl text-black">Program</h2>
        ...
        <div className="w-full flex flex-col gap-6">
          ...
          <div className="order-2 lg:order-1 w-full" id="novinky">
            <h2 className="font-light text-xl sm:text-2xl text-black">Novinky</h2>
